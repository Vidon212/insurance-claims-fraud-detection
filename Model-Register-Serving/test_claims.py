...
# BentoML expects a dictionary input for DataFrame, typically matching the pandas 'split' orientation or similar structure.
# Using orient='split' provides {'columns': [...], 'data': [...], 'index': [...]} which is a valid object.
response = requests.post("http://127.0.0.1:3000/predict", json=df_test.to_dict(orient="split"))
