...
# Generate random health claims data
num_samples = 1000
data = {
...
df.to_csv('random_health_claims.csv', index=False)

print("Random health claims data generated and saved to 'random_health_claims.csv'.")